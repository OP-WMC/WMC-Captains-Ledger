    ...
    <div className={`group relative overflow-hidden rounded-2xl shadow-xl transition-all duration-300 transform hover:scale-105 hover:shadow-2xl ${
      ...
      {important && (
        <div className="absolute top-2 right-2 sm:top-4 sm:right-4 z-10">
          <div className="bg-gradient-to-r from-red-500 to-red-600 text-white px-2 sm:px-3 py-1 rounded-full text-xs font-bold flex items-center shadow-lg">
      ...
      <div className="p-4 sm:p-6">
        ...
        <div className="flex flex-col sm:flex-row items-start mb-2 sm:mb-4">
          <div className={`p-2 sm:p-3 rounded-full mr-0 sm:mr-4 ${
        ...
        <div className="mb-4 sm:mb-6">
          <p className="text-blue-500 font-semibold dark:text-gray-300 leading-relaxed text-sm sm:text-base">
            {body}
          </p>
        </div>

        {/* Footer */}
        <div className="flex flex-col sm:flex-row items-center justify-between text-xs sm:text-sm text-blue-500 dark:text-gray-400 border-t border-blue-300 dark:border-gray-600/30 pt-3 sm:pt-4 gap-2 sm:gap-0">
