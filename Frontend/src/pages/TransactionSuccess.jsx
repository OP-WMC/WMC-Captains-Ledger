...
const TransactionSuccess = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center dark:text-white text-black space-y-6 text-center px-4">
      <CheckCircle className="w-24 h-24 text-green-400" />
      <h1 className="text-3xl font-orbitron font-bold">Payment Successful</h1>
      <p className="text-black dark:text-avengers-silver">Your mission funds have been deployed.</p>
      ...
      {message && (
        <p className="text-sm mt-3 text-black dark:text-avengers-silver">{message}</p>
      )}
    </div>
  );
};
